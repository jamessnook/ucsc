...
require_once(dirname(dirname(__FILE__)) . '/drc-etext/protected/vendors/simplesaml/lib/_autoload.php');
...
$configdir = dirname(dirname(__FILE__)) . '/drc-etext/protected/vendors/simplesaml/config';
