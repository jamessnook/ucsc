	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Texts', 'url'=>array('/text/admin'), 'visible'=>Yii::app()->user->checkAccess('admin')),
				array('label'=>'Text Formats', 'url'=>array('/format/admin'), 'visible'=>Yii::app()->user->checkAccess('admin')),
