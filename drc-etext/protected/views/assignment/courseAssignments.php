<?php
	...
	$this->menu=array(
		...
		array('label'=>'Books','url'=>array('course/books', 'termCode'=>$model->term_code, 'class_num'=>$model->class_num)),
		array('label'=>'Students', 'url'=>array('user/drcStudents', 'termCode'=>$model->term_code, 'class_num'=>$model->class_num)),
...
<div class="page-head">
	<div class="row-fluid">
		...
		<ul class="nav nav-pills pull-right">
			<li><a href="<?php $this->createUrl('assignment/create'); ?>"><i class="icon-plus"></i> Add Request</a></li>
		</ul>
	</div><!--/row-->
</div><!--/head-->
