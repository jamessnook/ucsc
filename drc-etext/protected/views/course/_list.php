	...
	$this->widget('zii.widgets.grid.CGridView', array(
		...
		'columns'=>array(
			array( 
				...
				'urlExpression'=>'array(\'course/index\', \'view\'=>\'assignments\', \'term_code\'=>$data->term_code, \'class_num\'=>$data->class_num)', 
			),
			array( 
				'header'=>'Class Id', 
				'name'=>'idString()', 
			...
			array( 
				...
				'urlExpression'=>'array(\'course/index\', \'view\'=>\'assignments\', \'term_code\'=>$data->term_code, \'class_num\'=>$data->class_num, \'username\'=>\''. $model->username . '\')', 
			),
			 array( 
				'header'=>'Status', 
				'class'=>'LinksColumn',
