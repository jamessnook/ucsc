...
class DrcRequestController extends Controller
{
	/**
	...
	{
		$model=new DrcRequest;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['DrcRequest']))
		{
			$model->attributes=$_POST['DrcRequest'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('DrcRequest');
	...
	{
		$model=DrcRequest::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='drc-request-form')
		{
