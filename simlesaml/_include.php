...
require_once(dirname(dirname(__FILE__)) . '../ucsc/drc_etext/protected/vendors/simplesaml/lib/_autoload.php');
...
$configdir = dirname(dirname(__FILE__)) . '../ucsc/drc_etext/protected/vendors/simplesaml/config';
